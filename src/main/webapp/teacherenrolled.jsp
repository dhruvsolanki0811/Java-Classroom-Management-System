...
<ul class="menu">
 ...
 <main>
    ...
    <strong align="centre">Remove Teacher</strong>
...
<%  
                                ...
                                con = DriverManager.getConnection("jdbc:mysql://localhost/student","root","root");
                                  ...
                                  String query = "SELECT teacher_name,t.email as mail , subject_name "+
                                  "FROM teacher AS t "+
 ...
 <tr>
               <td><%=rs.getString("teacher_name") %></td>
     			...
     			<td><a href="remove?user=<%=rs.getString("mail") %>&redirect=teacher" >Remove</a></td>
