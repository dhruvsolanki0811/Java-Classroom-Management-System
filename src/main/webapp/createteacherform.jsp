 ...
 <main>
    ...
    <div class="StudentForm"></br>
        ...
        <form action="createteacher" method="post">
            <input type="text" placeholder="Teacher Name"  name="t_name"></br></br>
            <input type="text" placeholder="E-Mail"  name="t_email"></br></br>
            <input type="password" placeholder="Password"  name="t_pass"></br></br>
            <button type="submit" class="button">Create</button></br>
            <%if(session.getAttribute("teachercreated")!=null){%>
            <span style="color:red;" ><%=session.getAttribute("teachercreated") %></span>
            <%session.removeAttribute("teachercreated");
            }%>
        </form>
    </div>
</div>
